...
% Packages
\usepackage{
  titlesec,  textcomp,  fixltx2e,  color,  fullpage,  graphicx,  afterpage,  float,  parskip,  xfrac,  gensymb, verbatim, framed, titlesec,  mathtools, pdfpages, etoolbox, hyperref
}
