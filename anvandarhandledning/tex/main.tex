...
\input{./tex/detalj.intro}
  \section{Sökvyn}
  \input{./tex/detalj.sok}
  \section{Receptvyn}
  \input{./tex/detalj.recept}
  \section{Lägg till receptvyn}
  \input{./tex/detalj.lagg_till_recept}
  \section{Lägg till ingrediensvyn}
  \input{./tex/detalj.lagg_till_ingrediens}
  \section{Importera och exportera recept}
  \input{./tex/detalj.import}
