...
% Packages
\usepackage{tikz,  textcomp,  fixltx2e,  color,  fullpage,  graphicx,  afterpage,  float,  parskip,  xfrac,  gensymb,  titlesec,  mathtools, pdfpages, etoolbox, hyperref
}
...
\hypersetup {
  ...
  pdftitle={MatLabb - Användarhandledning},                 % title
...
\title{MatLabb - Användarhandledning}
\date{\today}
...
\newcommand{\reptype}{Användarhandledning}
